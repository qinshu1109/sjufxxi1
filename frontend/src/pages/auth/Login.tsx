  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-text-secondary">登录您的账户以继续使用数据分析平台</p>
      </div>

      <Form name="login" onFinish={handleSubmit} autoComplete="off" size="large" layout="vertical">
        <Form.Item
          name="username"
          rules={[
        ...
        >
          <Input prefix={<UserOutlined />} placeholder="用户名 (试试 admin 或 user)" />
        </Form.Item>
        ...
        >
          <Input.Password prefix={<LockOutlined />} placeholder="密码 (任意6位以上)" />
        </Form.Item>
      ...
      <div className="text-center">
        ...
        <Link to="/auth/register" className="ml-1 text-primary-500 hover:text-primary-600">
          立即注册
        </Link>
      </div>
      ...
      <div className="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
        ...
        <ul className="space-y-1 text-sm text-blue-600 dark:text-blue-400">
          <li>
            • 管理员：用户名 <code>admin</code>，密码任意6位以上
          </li>
          <li>
            • 普通用户：用户名 <code>user</code>，密码任意6位以上
          </li>
        </ul>
      </div>
    </div>
